...
if __name__ == "__main__":
    ...
    main(
        appid="aa5e3e1c",
        api_secret="ZDM1MTEwZjg4Yjk4ZmM3ZjYwYWQzM2Vm",
        api_key="ff4d2237243859a82664449982afca86",
        #appid、api_secret、api_key三个服务认证信息请前往开放平台控制台查看（https://console.xfyun.cn/services/bm35）
        gpt_url="wss://spark-api.xf-yun.com/v4.0/chat",      # Spark4.0Ultra环境的地址
